...
class MobileMenu {
    constructor() {
        ...
        this.menuIcon = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.burger-icon');
...
class StickyHeader {
    constructor(){
        ...
        this.siteHeader = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.site-header');
        this.headerTriggerElem = __WEBPACK_IMPORTED_MODULE_0_jquery___default()('.large-hero__title');
            ...
            new Waypoint({
                ...
                handler: function(direction) {
                    if (direction == 'down') {
                        ...
                        __WEBPACK_IMPORTED_MODULE_0_jquery___default()(matchingHeaderLink).toggleClass('is-current-link');
                    }
                },
                offset: '18%'
            });
...
let mobMenu = new __WEBPACK_IMPORTED_MODULE_0__modules_MobileMenu__["a" /* default */]();
